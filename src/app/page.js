          ...
          <footer className={styles.footer}>
            ...
            <div className={styles.callToAction}>
              <div className={styles.callToActionContent}>
                <h2 className={styles.callToActionTitle}>Let’s talk about your project</h2>
                <p className={styles.callToActionText}>Ready to take it to the next level? Contact us today and find out how our expertise can help your business grow.</p>
              </div>
            ...
            <div className={styles.footerContainer}>
              ...
              <div className={styles.footerBottomContent}>
                <div className={styles.footerAdressContainer}>
                  <p className={styles.adress}>Designo Central Office</p>

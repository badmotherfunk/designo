        ...
        <div className="footerContainer">
          ...
          <div className="footerBottomContent">
            ...
            <div className="footerSocialContainer">
              ...
              <Link href="https://facebook.com" target="_blank"  className="socials" >
              ...
              <Link href="https://www.youtube.com/" target="_blank"  className="socials" >
              ...
              <Link href="https://twitter.com" target="_blank"  className="socials" >
              ...
              <Link href="https://pinterest.com" target="_blank"  className="socials" >
              ...
              <Link href="https://instagram.com" target="_blank"  className="socials" >
